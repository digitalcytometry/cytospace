...
4. __We highly recommend using Seurat v3 rather than v4 for cell type fraction estimation.__ Running cell type fraction estimation from within the `cytospace` environment will ensure this.
