...
- Unlike other methods which generally work in a shared embedding space or on pre-selected marker genes, CytoSPACE uses all genes shared between scRNA-seq and ST sets for mapping, helping it retain sensitivity to subtle cell states.
