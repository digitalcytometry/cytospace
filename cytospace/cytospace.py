...
def main_cytospace(scRNA_path, cell_type_path, st_path, coordinates_path,
                   ...
                   method="shortest_augmenting_path", rotation_flag=True, plot_off=False, spot_size=170,
    ...
    if not plot_off:
        plot_output(cell_type_fraction_estimation_path, num_row, num_column, rotation_degrees, rotation_flag,
                    spot_size, output_path, output_prefix, assigned_nodes, new_cell_index, coordinates_data)
